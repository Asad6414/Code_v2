...
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code_v2/main/data67-20.csv", show_col_types = FALSE)
...
bv.est <- VAR(data.bv, p = 3, type = "both", season = NULL, exog = NULL)
summary(bv.est)
...
#To load the data and store the time series objects
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code_v2/main/data_tr67-20.csv", show_col_types = FALSE)
#data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code_v2/main/data67-20.csv", show_col_types = FALSE)
